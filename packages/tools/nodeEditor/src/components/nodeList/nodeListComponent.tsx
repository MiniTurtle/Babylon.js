...
export class NodeListComponent extends React.Component<INodeListComponentProps, { filter: string }> {
    ...
    private static _Tooltips: { [key: string]: string } = {
        ...
        ReturnBlock: "A final node that will return early and set the fragment color",
    ...
    render() {
        ...
        const allBlocks: any = {
            ...
            Output_Nodes: ["VertexOutputBlock", "FragmentOutputBlock", "DiscardBlock", "ReturnBlock", "ClipPlanesBlock", "FragDepthBlock"],
            Particle: [
